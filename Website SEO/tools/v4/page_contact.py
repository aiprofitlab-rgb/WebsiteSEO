    ...
    <div class="faq" style="margin-top:clamp(22px,3vw,38px)">
      ...
      <details>
        ...
        <p class="ans">Not to keep anything working. The first year of hosting and care is in the build price.
          Two monthly services are optional and neither is required: the Growth Desk at OMR 75/month, and
          <a href="/en/services/#visibility">the Visibility Desk</a> &mdash; the ongoing SEO and GEO work
          &mdash; at OMR 300/month.</p>
      </details>
      <details>
      ...
      <details>
        ...
        <p class="ans">The First Inquiry Promise: no real buyer inquiry within 30 days of going live and I rebuild
          it free. If you still don&#8217;t get one, you get your money back. <a href="/en/services/#visibility">The
          Visibility Desk</a> carries its own named guarantee: 6 months in, if Google and ChatGPT still do not
          name you, I refund that service&#8217;s fees and keep working free until they do.</p>
      </details>
      <details>
...
META = dict(
  ...
  "mainEntity":[
    ...
    {"@type":"Question","name":"Is there a monthly fee?","acceptedAnswer":{"@type":"Answer","text":"Not to keep anything working. The first year of hosting, security and care is included in the build price. Two monthly services are optional and neither is ever required: the Growth Desk at OMR 75 a month, and the Visibility Desk - the ongoing SEO and GEO work of staying named by Google and by AI assistants - at OMR 300 a month."}},
    ...
    {"@type":"Question","name":"What if it doesn't work?","acceptedAnswer":{"@type":"Answer","text":"The First Inquiry Promise: no real buyer inquiry within 30 days of going live and it gets rebuilt free until you get one. If you still don't, you get your money back. The Visibility Desk carries its own named guarantee: 6 months in, if Google and ChatGPT still do not name you, that service's fees are refunded and the work continues free until they do."}},
