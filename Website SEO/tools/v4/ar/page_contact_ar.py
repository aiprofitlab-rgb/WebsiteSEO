...
from ar_common import (AUTO, DASH, DESK, PROMISE, SITE, VIS, bundle_ar,
                       num, price_ar, wa)
    ...
    <div class="faq" style="margin-top:clamp(22px,3vw,38px)">
      ...
      <details>
        ...
        <p class="ans">لا شيء مطلوب لإبقاء النظام يعمل. السنة الأولى من الاستضافة والحماية والرعاية
          مشمولة في سعر البناء. وهناك خدمتان شهريتان اختياريتان، ولا واحدة منهما مطلوبة:
          {DESK} بـ{price_ar('desk')} شهرياً، و<a href="{SVC}#visibility">{VIS}</a> &mdash; عمل الـ SEO
          والـ GEO المستمر &mdash; بـ{price_ar('visibility')} شهرياً.</p>
      </details>
      <details>
      ...
      <details>
        ...
        <p class="ans">{PROMISE}: إن لم يصلك استفسار حقيقي من مشترٍ خلال {num('30')} يوماً من الإطلاق،
          أعيد بناءه مجاناً. وإن لم يصلك بعدها، تسترد مالك. و<a href="{SVC}#visibility">{VIS}</a> يحمل
          ضماناً خاصاً به: بعد {num('6')} أشهر، إن لم يكن جوجل و‏ChatGPT يذكرانك، أعيد رسوم تلك الخدمة
          وأواصل العمل مجاناً حتى يذكراك.</p>
      </details>
      <details>
...
META = dict(
  ...
  "mainEntity":[
    ...
    {"@type":"Question","name":"هل هناك رسوم شهرية؟","acceptedAnswer":{"@type":"Answer","text":"لا شيء مطلوب لإبقاء النظام يعمل. السنة الأولى من الاستضافة والحماية والرعاية مشمولة في سعر البناء. وهناك خدمتان شهريتان اختياريتان وغير مطلوبتين أبداً: مكتب النمو بـ75 ريالاً شهرياً، ومكتب الظهور — عمل الـ SEO والـ GEO المستمر لإبقاء اسمك حاضراً في جوجل وفي مساعدي الذكاء الاصطناعي — بـ300 ريال شهرياً."}},
    ...
    {"@type":"Question","name":"وماذا لو لم ينجح؟","acceptedAnswer":{"@type":"Answer","text":"وعد أول استفسار: إن لم يصلك استفسار حقيقي من مشترٍ خلال 30 يوماً من الإطلاق، يُعاد بناؤه مجاناً حتى يصلك. وإن لم يصلك بعدها، تسترد مالك. ومكتب الظهور يحمل ضماناً خاصاً به: بعد 6 أشهر، إن لم يكن جوجل وChatGPT يذكرانك، تُعاد رسوم تلك الخدمة ويستمر العمل مجاناً حتى يذكراك."}},
