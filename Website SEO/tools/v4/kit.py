...
/* -------------------------------------------------------------- footer */
.foot{background:var(--teal-950);color:rgba(241,239,232,.74);padding:clamp(58px,7vw,92px) 0 40px;font-size:1rem}
.foot .fmark{width:170px;margin-bottom:20px}
.foot .slogan{font-family:var(--display);font-size:clamp(1.25rem,2.4vw,1.7rem);color:var(--cream);margin:0 0 8px}
.foot .slogan-ar{font-size:1.15rem;color:var(--amber-pale);margin:0}
.foot-grid{display:grid;grid-template-columns:1.4fr 1fr 1fr;gap:clamp(26px,4vw,56px);align-items:start}
  ...
  <div class="wrap">
    <div class="foot-grid">
      ...
      <div>
        <h4>Talk to me</h4>
        <ul>
          <li><a href="{WA}?text=Hello%20Nahid">WhatsApp <span dir="ltr">+968 9924 5250</span></a></li>
