...
def update_hub(hub_file, lang, article_dir):
    ...
    print(f"SUCCESS: Updated {hub_file} with {len(articles)} articles.")

if __name__ == "__main__":
    base_dir = os.path.dirname(os.path.abspath(__file__))
    update_hub(os.path.join(base_dir, "public_html", "blog", "index.html"), "en", os.path.join(base_dir, "public_html", "blog", "en"))
    update_hub(os.path.join(base_dir, "public_html", "blog-ar", "index.html"), "ar", os.path.join(base_dir, "public_html", "blog", "ar"))
