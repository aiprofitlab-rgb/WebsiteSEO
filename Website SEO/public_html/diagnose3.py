...
files_to_check = {
    ...
    '/Users/nahid/Desktop/Nahid/AI Profit Lab/Website/Website SEO/public_html/index.html': 7,   # script 8 = index 7
    '/Users/nahid/Desktop/Nahid/AI Profit Lab/Website/Website SEO/public_html/process.html': 5,
    '/Users/nahid/Desktop/Nahid/AI Profit Lab/Website/Website SEO/public_html/onboarding.html': 4,
}
...
for filepath, script_idx in files_to_check.items():
    ...
    if res.returncode != 0:
        ...
        if lineno_match:
            ...
            print(f"\n=== {os.path.basename(filepath)} script #{script_idx+1}, error at line {ln} ===")
            start = max(0, ln-5)
