...
blog_ar_path = os.path.join(base_dir, "blog", "ar")
...
blog_en_path = os.path.join(base_dir, "blog", "en")
...
academy_ar_path = os.path.join(base_dir, "academy", "ar")
...
academy_en_path = os.path.join(base_dir, "academy", "en")
