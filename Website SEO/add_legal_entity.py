"""
add_legal_entity.py
Adds "Lotus Gulf International" legal entity branding across the site:
...
def process_file(filepath):
    ...
    content = content.replace(
        ...
        'Profit Lab — a brand of Lotus Gulf International • All Rights Reserved • Muscat, Oman'
    )

    # Pattern B: "Profit Lab • All Rights Reserved • Serving the GCC"
    content = content.replace(
        'Profit Lab • All Rights Reserved • Serving the GCC',
        'Profit Lab — a brand of Lotus Gulf International • All Rights Reserved • Serving the GCC'
    )
    ...
    content = content.replace(
        ...
        'Profit Lab — علامة تجارية لشركة لوتس الخليج العالمية • جميع الحقوق محفوظة • مسقط، عمان'
    )

    # Pattern B: "Profit Lab • جميع الحقوق محفوظة • نخدم دول الخليج"
    content = content.replace(
        'Profit Lab • جميع الحقوق محفوظة • نخدم دول الخليج',
        'Profit Lab — علامة تجارية لشركة لوتس الخليج العالمية • جميع الحقوق محفوظة • نخدم دول الخليج'
    )
